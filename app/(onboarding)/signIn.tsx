      ...
      <LSCIcon style={{alignSelf: 'center', position: 'absolute', top: 40}} />
        ...
        <View style={styles.authbox}>
          ...
          <View style={styles.textBox}>
            ...
            <Text style={{color: '#636363', fontWeight: 400}}>It&apos;s good to have you</Text>
          ...
          <View style={styles.buttonbox}>
            <TouchableOpacity style={styles.buttonOne} onPress={()=> route.push('/(tabs)/home')}>
              <Text style={{color: '#fff', fontWeight: 600, fontSize: 14}}>Sign in</Text>
            </TouchableOpacity>

             <View style={{paddingVertical: 5}}>
            <Text style={{alignSelf: 'center'}}>Don&apos;t have an account yet?
                <Link href={'/(onboarding)/signUp'} style={{color: '#326BFE'}}> Sign up</Link></Text>
            </View>
